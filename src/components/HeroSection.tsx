...
export default function HeroSection() {
  return (
    <section className="bg-amber-200 relative flex px-40 py-4">
      <div className="flex flex-col max-w-lg p-4 gap-2">
        ...
        <div className="flex flex-col gap-4 items-start mt-4">
          ...
          <button>
            <a
              href="reservations"
              className="mt-2 px-4 py-2 bg-amber-500 text-white rounded-lg shadow-md hover:bg-amber-600"
            >
              Reserve a Table
            </a>
          </button>
      ...
      <div className="absolute right-[10%] top-[70%] transform -translate-y-1/2">
        <img
          src={image}
